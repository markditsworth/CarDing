...
lp_response_path = "path/to/plate/response"
...
ALPR_KEY = 'openALPR API KEY'

########################################################
# Email Account Information must be edited in notify2()
########################################################
